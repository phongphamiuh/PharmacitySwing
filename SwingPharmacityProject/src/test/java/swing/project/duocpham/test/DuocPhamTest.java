...
public class DuocPhamTest {
	...
	public void themDuocPham() {		
		...
		DuocPham dp1=new DuocPham(18042041l, "pharmtis", 5, 100, 120,"Hop", parsedDate,parsedDate, parsedDate, "Thuoc khang sinh",loaiDuocPham,nhaCungCap);
		DuocPham dp2=new DuocPham(18042042l, "hiromotru", 5, 100,120,"Hop",parsedDate, parsedDate, parsedDate, "Thuoc khang sinh",loaiDuocPham,nhaCungCap);
		DuocPham dp3=new DuocPham(18042043l, "islait", 5, 100, 120,"Hop",parsedDate, parsedDate, parsedDate, "Thuoc khang sinh",loaiDuocPham1,nhaCungCap);
		DuocPham dp4=new DuocPham(18042044l, "hibstachi", 5, 100, 120,"Hop",parsedDate, parsedDate, parsedDate, "Thuoc khang sinh",loaiDuocPham2,nhaCungCap);
		DuocPham dp5=new DuocPham(18042045l, "khsamara", 5, 100, 120,"Hop",parsedDate, parsedDate, parsedDate, "Thuoc khang sinh",loaiDuocPham3,nhaCungCap);
